...
from .document2xml1207converter import Document2Xml1207Converter, ReplayDocument2Xml1207Converter
...
class SendToSEVOVVProcess():
    ...
    def send_message(self):
        if self.outgoing_doc.referred_document:
            conv = ReplayDocument2Xml1207Converter(document=self.outgoing_doc.document,
                                                   referred_document=self.outgoing_doc.referred_document,
                                                   message_id=self.outgoing_doc.message_id,
                                                   consumer=self.outgoing_doc.to_org,
                                                   sign=self.outgoing_doc.sign.sign,
                                                   attestation=self.outgoing_doc.attestation or 0,
                                                   comment=self.outgoing_doc.comment or 0)
        else:
